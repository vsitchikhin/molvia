 ...
 * search in `backend/tests/search-corpus.integration.test.ts` (MOL-13), and the rules
 * themselves are held one case each in `search.integration.test.ts`. `distance` is not
