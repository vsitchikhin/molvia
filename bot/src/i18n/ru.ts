...
export const ru = {
  ...
  'erase.prompt':
    ...
    'Уйдёт всё, что Molvia о вас знает: покупки, оценки и отзывы, выбор в поиске, отметки о ' +
    'визитах, настройки и входы на всех устройствах. Товары и магазины, которые вы добавили ' +
    'в общий справочник, останутся — без вашего имени.\n\n' +
    'Отменить это нельзя.',
