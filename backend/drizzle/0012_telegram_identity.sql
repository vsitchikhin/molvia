...
--
-- Справочник и места переживают: у `items.created_by` внешний ключ `ON DELETE SET NULL`, так
-- что позиции остаются, потеряв автора. Кеш курсов владельца не знает и не трогается.
--
